...
INSERT INTO `products` (`id`, `dcode`, `dname`, `price`) VALUES
(1, 1, 'Crocin', 5),
(2, 2, 'Paracetamol', 10),
(3, 3, 'Antacids', 20),
(4, 4, 'Savlon', 100);
...
INSERT INTO `saless` (`id`, `cname`, `cno`, `subtotal`, `pay`, `bal`, `date`) VALUES
(2, 'Aftab', 12345675, 115, 120, 5, '2023-02-21 11:28:13');
